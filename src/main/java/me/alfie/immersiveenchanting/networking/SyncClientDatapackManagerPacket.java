...
public record SyncClientDatapackManagerPacket(CostRegistry costRegistry,
    ...
    public static final Type<@NotNull SyncClientDatapackManagerPacket> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(ImmersiveEnchanting.MODID, "sync_client_cost_manager_packet"));
