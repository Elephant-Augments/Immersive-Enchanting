...
public record TransmutePacket() implements NetworkPacket<TransmutePacket> {
    ...
    public static final StreamCodec<FriendlyByteBuf, TransmutePacket> STREAM_CODEC = StreamCodec.unit(new TransmutePacket());
    ...
    public void exec(NetworkEvent.Context context) {
        ...
        Holder<Enchantment> oldEnchantment = EnchantmentUtil.getStoredEnchantment(ancientBookStack, level.registryAccess());
