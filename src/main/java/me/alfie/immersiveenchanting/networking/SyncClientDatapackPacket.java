...
public record SyncClientDatapackPacket(DataMap dataMap) implements ModNetworkPacket<SyncClientDatapackPacket> {
    ...
    public static final Type<@NotNull SyncClientDatapackPacket> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(ImmersiveEnchanting.MODID, "sync_client_datapack_packet"));
