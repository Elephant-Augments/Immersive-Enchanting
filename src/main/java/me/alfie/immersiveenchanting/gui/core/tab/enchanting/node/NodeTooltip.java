...
public class NodeTooltip {
    ...
    public NodeTooltip(Node node, EnchantingTableScreen screen, List<CostEntry> validCosts) {
        ...
        //Create components
        tooltipTitle = new TooltipTitle(this, Sprite.TOOLTIP_WIDGETS.get());
        tooltipDescription = new TooltipDescription(this, Sprite.TOOLTIP_WIDGETS.get());
    }
    ...
    public void render(GuiGraphics graphics) {
        ...
        //Title Settings
        ResourceLocation titleTexture = Sprite.TOOLTIP_WIDGETS.get();
        tooltipTitle.setSpriteTexture(titleTexture);

        //Draw
        tooltipDescription.draw(graphics, 52);

        int uvOffset = node.isObtained() ? 0 : 26;
        tooltipTitle.draw(graphics, uvOffset);
    }
