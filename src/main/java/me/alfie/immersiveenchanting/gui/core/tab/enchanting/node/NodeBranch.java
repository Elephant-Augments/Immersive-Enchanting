...
public class NodeBranch {
    ...
    public void addNode(Node node) {
        nodes.add(node);
        screen.enchantingTab.getRenderedNodes().add(node);
    }

    public static void calculateNodeAnglesAndStep(EnchantingTableScreen screen) {
        if (screen == null || screen.enchantingTab.branches.isEmpty() || screen.enchantingTab.branches.size() == 1) {
            node_step = 40;
        ...
        List<NodeBranch> branches = screen.enchantingTab.branches;
