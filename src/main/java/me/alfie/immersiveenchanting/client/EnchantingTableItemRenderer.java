...
public class EnchantingTableItemRenderer extends EnchantTableRenderer {
    ...
    @Override
    public void render(EnchantmentTableBlockEntity blockEntity, float partialTicks, PoseStack poseStack,
    ...
    private void renderFloatingTool(EnchantmentTableBlockEntity blockEntity, ItemStack stack,
