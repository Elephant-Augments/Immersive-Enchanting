...
public record RemovingLine(NodeTooltip tooltip) implements DescriptionLine {
    @Override
    ...
    public @NotNull Component getText() {
        return Component.translatable("immersiveenchanting.tooltip.desc.removing_enchantment")
