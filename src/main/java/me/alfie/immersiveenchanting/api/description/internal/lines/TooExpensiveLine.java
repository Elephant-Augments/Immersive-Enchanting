...
/** Shows a vanilla-style "Too Expensive!" message when an incoming enchantment exceeds the XP cost limit. */
public record TooExpensiveLine(NodeTooltip tooltip) implements DescriptionLine {
    ...
    public @NotNull Component getText() {
        return Component.translatable("immersiveenchanting.tooltip.desc.too_expensive")
